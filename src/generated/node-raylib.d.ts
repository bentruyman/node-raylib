...
declare module "raylib" {
  ...
  export function LoadAutomationEventList(
    fileName: string,
  ): AutomationEventList;
  ...
  /** Ease: Linear */
  export function EaseLinearNone(
    t: number,
    b: number,
    c: number,
    d: number,
  ...
  /** Ease: Linear In Out */
  export function EaseLinearInOut(
    t: number,
    b: number,
    c: number,
    d: number,
  ...
  /** Ease: Cubic In Out */
  export function EaseCubicInOut(
    t: number,
    b: number,
    c: number,
    d: number,
  ...
  /** Ease: Elastic Out */
  export function EaseElasticOut(
    t: number,
    b: number,
    c: number,
    d: number,
  ...
  /** Ease: Elastic In Out */
  export function EaseElasticInOut(
    t: number,
    b: number,
    c: number,
    d: number,
  ...
  /**  */
  export function Vector2ClampValue(
    v: Vector2,
    min: number,
    max: number,
  ): Vector2;
  ...
  /**  */
  export function Vector3ClampValue(
    v: Vector3,
    min: number,
    max: number,
  ): Vector3;
  ...
  /**  */
  export function QuaternionSubtract(
    q1: Quaternion,
    q2: Quaternion,
  ): Quaternion;

  /**  */
  export function QuaternionSubtractValue(
    q: Quaternion,
    sub: number,
  ): Quaternion;
  ...
  export function GuiLoadIcons(
    fileName: string,
    loadIconsName: boolean,
  ): number;

  /** Draw icon using pixel size at specified position */
  export function GuiDrawIcon(
    iconId: number,
    posX: number,
    posY: number,
    pixelSize: number,
  ...
  export function GuiScrollPanel(
    bounds: Rectangle,
    text: string,
    content: Rectangle,
    scroll: number,
  ...
  export function GuiToggleGroup(
    bounds: Rectangle,
    text: string,
    active: number,
  ): number;
  ...
  export function GuiToggleSlider(
    bounds: Rectangle,
    text: string,
    active: number,
  ): number;
  ...
  export function GuiDropdownBox(
    bounds: Rectangle,
    text: string,
    active: number,
    editMode: boolean,
  ...
  export function GuiValueBoxFloat(
    bounds: Rectangle,
    text: string,
    textValue: string,
    value: number,
  ...
  export function GuiProgressBar(
    bounds: Rectangle,
    textLeft: string,
    textRight: string,
    value: number,
  ...
  export function GuiTextInputBox(
    bounds: Rectangle,
    title: string,
    message: string,
    buttons: string,
  ...
  export function GuiColorPicker(
    bounds: Rectangle,
    text: string,
    color: number,
  ): number;
  ...
  export function GuiColorBarAlpha(
    bounds: Rectangle,
    text: string,
    alpha: number,
  ): number;
  ...
  export function GuiColorBarHue(
    bounds: Rectangle,
    text: string,
    value: number,
  ): number;
  ...
  export function GuiColorPickerHSV(
    bounds: Rectangle,
    text: string,
    colorHsv: number,
  ): number;
  ...
  export function GuiColorPanelHSV(
    bounds: Rectangle,
    text: string,
    colorHsv: number,
  ): number;
  ...
  export function rlTextureParameters(
    id: number,
    param: number,
    value: number,
  ): void;
  ...
  export function rlCubemapParameters(
    id: number,
    param: number,
    value: number,
  ): void;
  ...
  export function rlBlitFramebuffer(
    srcX: number,
    srcY: number,
    srcWidth: number,
    srcHeight: number,
  ...
  export function rlSetBlendFactors(
    glSrcFactor: number,
    glDstFactor: number,
    glEquation: number,
  ): void;
  ...
  export function rlLoadRenderBatch(
    numBuffers: number,
  ...
  export function rlLoadVertexBuffer(
    buffer: number,
    size: number,
    dynamic: boolean,
  ): number;
  ...
  export function rlLoadVertexBufferElement(
    buffer: number,
    size: number,
    dynamic: boolean,
  ): number;
  ...
  export function rlUpdateVertexBuffer(
    bufferId: number,
    data: number,
    dataSize: number,
    offset: number,
  ...
  export function rlUpdateVertexBufferElements(
    id: number,
    data: number,
    dataSize: number,
    offset: number,
  ...
  export function rlSetVertexAttribute(
    index: number,
    compSize: number,
    type: number,
    normalized: boolean,
  ...
  export function rlSetVertexAttributeDivisor(
    index: number,
    divisor: number,
  ): void;

  /** Set vertex attribute default value, when attribute to provided */
  export function rlSetVertexAttributeDefault(
    locIndex: number,
    value: number,
    attribType: number,
    count: number,
  ...
  export function rlDrawVertexArrayElements(
    offset: number,
    count: number,
    buffer: number,
  ): void;
  ...
  export function rlDrawVertexArrayInstanced(
    offset: number,
    count: number,
    instances: number,
  ): void;
  ...
  export function rlLoadTextureDepth(
    width: number,
    height: number,
  ...
  export function rlLoadTextureCubemap(
    data: number,
    size: number,
    format: number,
    mipmapCount: number,
  ...
  export function rlUpdateTexture(
    id: number,
    offsetX: number,
    offsetY: number,
    width: number,
  ...
  export function rlGetGlTextureFormats(
    format: number,
  ...
  export function rlGenTextureMipmaps(
    id: number,
    width: number,
    height: number,
    format: number,
  ...
  export function rlReadTexturePixels(
    id: number,
    width: number,
    height: number,
    format: number,
  ...
  export function rlFramebufferAttach(
    fboId: number,
    texId: number,
    attachType: number,
    texType: number,
  ...
  export function rlLoadShaderProgram(
    vShaderId: number,
    fShaderId: number,
  ): number;
  ...
  export function rlGetLocationUniform(
    shaderId: number,
    uniformName: string,
  ): number;

  /** Get shader location attribute */
  export function rlGetLocationAttrib(
    shaderId: number,
    attribName: string,
  ): number;

  /** Set shader value uniform */
  export function rlSetUniform(
    locIndex: number,
    value: number,
    uniformType: number,
    count: number,
  ...
  export function rlSetUniformMatrices(
    locIndex: number,
    mat: number,
    count: number,
  ): void;
  ...
  export function rlSetUniformSampler(
    locIndex: number,
    textureId: number,
  ): void;
  ...
  export function rlComputeShaderDispatch(
    groupX: number,
    groupY: number,
    groupZ: number,
  ): void;
  ...
  export function rlLoadShaderBuffer(
    size: number,
    data: number,
    usageHint: number,
  ): number;
  ...
  export function rlUpdateShaderBuffer(
    id: number,
    data: number,
    dataSize: number,
    offset: number,
  ...
  export function rlReadShaderBuffer(
    id: number,
    dest: number,
    count: number,
    offset: number,
  ...
  export function rlCopyShaderBuffer(
    destId: number,
    srcId: number,
    destOffset: number,
    srcOffset: number,
  ...
  /** Bind image texture */
  export function rlBindImageTexture(
    id: number,
    index: number,
    format: number,
    readonly: boolean,
  ...
  export function rlSetMatrixProjectionStereo(
    right: Matrix,
    left: Matrix,
  ): void;

  /** Set eyes view offsets matrices for stereo rendering */
  export function rlSetMatrixViewOffsetStereo(
    right: Matrix,
    left: Matrix,
  ): void;
  ...
  export function SetShaderFloat(
    shader: Shader,
    locIndex: number,
    value: number,
  ): void;
  /** Set shader uniform int */
  export function SetShaderInt(
    shader: Shader,
    locIndex: number,
    value: number,
  ): void;
  /** Set shader uniform Vec2 */
  export function SetShaderVec2(
    shader: Shader,
    locIndex: number,
    value: Vector2,
  ): void;
  /** Set shader uniform Vec3 */
  export function SetShaderVec3(
    shader: Shader,
    locIndex: number,
    value: Vector3,
  ): void;
